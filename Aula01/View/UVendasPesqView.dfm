object frmVendaPesq: TfrmVendaPesq
  ...
  object cdsVendaPesq: TClientDataSet
    ...
    Data = {
      ...
      0064000444617461080008000000000005546F74616C08000400000000000846
      6174757261646104000100000000001144657363726963616F46617475726164
      6101004900000001000557494454480200020003000000}
    ...
    object cdsVendaPesqFaturada: TIntegerField
      DisplayWidth = 10
      FieldName = 'Faturada'
      Visible = False
    end
    object cdsVendaPesqDescricaoFaturada: TStringField
      DisplayLabel = 'Faturada'
      DisplayWidth = 9
      FieldName = 'DescricaoFaturada'
      Size = 3
    end
  end
end
